...
public class JobsController extends BaseController {
    ...
    public String edit(ModelMap modelMap,@RequestParam(value = "id",required = false) Integer id,
    		...
    		Jobs model = new Jobs();
		    if(editFlag > 0) {
		    	model = jobsService.selectById(id);
		    }
	...
	@GetMapping("data")
    @ResponseBody
    public Result data( @RequestParam(value = "post",required = false) String post) throws Exception{
    	Map<String,String> params = new HashMap<String, String>();
    	params.put("post", post);
    	
    	List<Jobs> jobs = jobsService.getByParams(params);
...
//
    ...
    public String save(Jobs model) {
        ...
        return jobsService.createOrUpdate(model) >= 1 ? "success" : "error";
    }
