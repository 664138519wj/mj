...
//        filters.put("release", "true");
    ...
    @PostMapping("save")
    @ResponseBody
    public String save(CourseOnline model) throws Exception{
        if (null == model) {
            return "error";
        }
        ...
        if (model.getId() != null && model.getId() > 0) {
            ...
            record.setHour(model.getHour() == null ? 0 : model.getHour());
            record.setMinute(model.getMinute() == null ? 0:model.getMinute());
            record.setSecond(model.getSecond() == null ? 0:model.getSecond());
            ...
            if (null != teacher) {
                model.setTeacherName(teacher.getName());
            }
            model.setCreateTime(new Date());
            model.setUpdateTime(new Date());
            model.setIsDelete(0);
            model.setHour(model.getHour() == null ? 0 : model.getHour());
            model.setMinute(model.getMinute() == null ? 0:model.getMinute());
            model.setSecond(model.getSecond() == null ? 0:model.getSecond());
